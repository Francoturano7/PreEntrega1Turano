...
function CartView() {
    const {cart, removeItem, clear, priceInCart,alreadyInCart} = useContext(cartContext);
    if (cart.length === 0 ) return <h1 className='greeting marginar' >Carrito de compras vacio</h1>
  return (
